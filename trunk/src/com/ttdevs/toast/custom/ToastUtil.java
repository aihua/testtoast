...
import com.ttdevs.toast.R;
import com.ttdevs.toast.R.id;
import com.ttdevs.toast.R.layout;
...
public class ToastUtil extends BaseThread {
	...
	private static final String QUITMSG = "_@toast_#quit_$flag_%avoid_&collison_"; // 退出的标记
